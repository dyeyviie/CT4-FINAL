    < script >
        ! function() {
            ...
            const jt = function(t, e = document.documentElement) {
                ...
                Kt = t => !(!t || "object" != typeof t) && (void 0 !== t.jquery && (t = t[0]), void 0 !== t.nodeType),
            ...
            function Ee(t, e, n, i, s) {
                ...
                const [o, r, a] = we(e, n, i), l = ve(t), c = l[a] || (l[a] = {}), h = ye(c, r, o ? n : null);
                        ...
                        return function i(s) {
                            ...
                            for (let {
                                ...
                                for (let a = o.length; a--;)
                                    if (o[a] === r) return s.delegateTarget = r, i.oneOff && Le.off(t, s.type, e, n), n.apply(r, [s]);
                            return null
                        }
                    }(t, n, i) : function(t, e) {
                        return function n(i) {
            ...
            const Le = {
                ...
                off: function(t, e, n, i) {
                    if ("string" != typeof e || !t) return;
                    const [s, o, r] = we(e, n, i), a = r !== e, l = ve(t), c = e.startsWith(".");
                    if (void 0 !== o) {
                        if (!l || !l[r]) return;
            ...
            class Ke extends ke {
                ...
                _addTouchEventListeners() {
                    const t = t => {
                        ...
                        n = t => {
                            !this._pointerEvent || "pen" !== t.pointerType && t.pointerType !== Ve || (this.touchDeltaX = t.clientX - this.touchStartX), this._handleSwipe(), "hover" === this._config.pause && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout((t => this.cycle(t)), 500 + this._config.interval))
                        };
                    jt(".carousel-item img", this._element).forEach((t => {
                        Le.on(t, "dragstart.bs.carousel", (t => t.preventDefault()))
                    })), this._pointerEvent ? (Le.on(this._element, "pointerdown.bs.carousel", (e => t(e))), Le.on(this._element, "pointerup.bs.carousel", (t => n(t))), this._element.classList.add("pointer-event")) : (Le.on(this._element, "touchstart.bs.carousel", (e => t(e))), Le.on(this._element, "touchmove.bs.carousel", (t => e(t))), Le.on(this._element, "touchend.bs.carousel", (t => n(t))))
                }
                _keydown(t) {
                ...
                static dataApiClickHandler(t) {
                    ...
                    const n = {...je.getDataAttributes(e),
            ...
            class on extends ke {
                constructor(t, e) {
                    super(t), this._isTransitioning = !1, this._config = this._getConfig(e), this._triggerArray = jt(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`);
                    const n = jt(sn);
                ...
                show() {
                    ...
                    let t, e;
                    this._parent && (t = jt(".show, .collapsing", this._parent).filter((t => "string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains(Je))), 0 === t.length && (t = null));
            ...
            class kn extends ke {
                ...
                show() {
                    ...
                    if (!Le.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                        ...
                        "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t => Le.on(t, "mouseover", te))), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle(mn), this._element.classList.toggle(mn), Le.trigger(this._element, "shown.bs.dropdown", e)
                    }
                }
                hide() {
                    if (Zt(this._element) || !this._menu.classList.contains(mn)) return;
            ...
            class ni extends ke {
                ...
                dispose() {
                    [window, this._dialog].forEach((t => Le.off(t, qn))), this._backdrop.dispose(), super.dispose(), Le.off(document, Xn)
                }
                handleUpdate() {
                    this._adjustDialog()
                }
            ...
            Le.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
                const e = Ut(this);
                ["A", "AREA"].includes(this.tagName) && t.preventDefault(), Le.one(e, Kn, (t => {
            ...
            class Si extends ke {
                ...
                hide() {
                    ...
                    t.classList.remove(Ci), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t => Le.off(t, "mouseover", te))), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
                    const e = this.tip.classList.contains(ki);
                    this._queueCallback((() => {
                        this._isWithActiveTrigger() || (this._hoverState !== Oi && t.parentNode && t.parentNode.removeChild(t), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), Le.trigger(this._element, this.constructor.Event.HIDDEN), this._popper && (this._popper.destroy(), this._popper = null))
                ...
                _setListeners() {
                    this._config.trigger.split(" ").forEach((t => {
                        if ("click" === t) Le.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t => this.toggle(t)));
                        else if ("manual" !== t) {
                    ...
                    }, Le.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this._config.selector ? this._config = {...this._config,
                        trigger: "manual",
                        selector: ""
                    } : this._fixTitle()
                }
                ...
                _getConfig(t) {
                    ...
                    return Object.keys(e).forEach((t => {
                        ...
                        ...
                        "object" == typeof t && t ? t : {}
                    }).container = !1 === t.container ? document.body : Xt(t.container), "number" == typeof t.delay && (t.delay = {
                        show: t.delay,
                        hide: t.delay
            ...
            class Ki extends ke {
                ...
                refresh() {
                    ...
                    jt(this._selector).map((t => {
                        ...
                        if (s) {
                            ...
                            if (t.width || t.height) return [je[e](s).top + n, i]
                        }
                        return null
                ...
                _activate(t) {
                    ...
                    const e = this._selector.split(",").map((e => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`)),
                        n = Pt(e.join(","));
                    n.classList.contains(zi) ? (Pt(".dropdown-toggle", n.closest(".dropdown")).classList.add(Ui), n.classList.add(Ui)) : (n.classList.add(Ui), Ht(n, ".nav, .list-group").forEach((t => {
                        Rt(t, ".nav-link, .list-group-item").forEach((t => t.classList.add(Ui))), Rt(t, ".nav-item").forEach((t => {
            ...
            class ts extends ke {
                ...
                _transitionComplete(t, e, n) {
                    ...
                    if (i && "LI" === i.nodeName && (i = i.parentNode), i && i.classList.contains("dropdown-menu")) {
                        ...
                        e && jt(".dropdown-toggle", e).forEach((t => t.classList.add(Yi))), t.setAttribute("aria-expanded", !0)
                    }
                    n && n()
                }
                static jQueryInterface(t) {
